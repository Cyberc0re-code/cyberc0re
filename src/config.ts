...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/Cyberc0re-code',     // Internal links should not include the base path, as it is automatically added
  ...
  links: [
    {
      ...
      url: 'https://www.linkedin.com/in/anshuman-sahoo1/',
    },
    {
      name: 'GitHub',
      icon: 'fa6-brands:github',
      url: 'https://github.com/Cyberc0re-code',
    },
  ],
}
